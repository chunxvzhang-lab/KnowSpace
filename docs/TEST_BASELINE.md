...
| `src/__tests__/ui-store.test.ts` | 32 | ✅ |
| `src/__tests__/tab-store.test.ts` | 29 | ✅ |
...
| `src/__tests__/app-smoke.test.tsx` | 9 | ✅ |
...
1. 用例总数 **不低于 543**（删除测试需在 PR 说明中论证）
2. 通过率 **100%**
