...
<p align="center" style="text-align: center;">
  ...
  <em>一张图胜过千言万语 · 28 大功能模块全景画册与深度实操图解</em>
</p>
...
| **03** | **三重视图自适应切换** | `分屏` / `源码` / `阅读` | 双栏分屏联动、极客编辑器、纯粹阅读 | [查看图解](#03-三重视图自适应切换) |
...
| **28** | **关于 KnowSpace 与团队致谢** | 活动栏关于图标 | 桌面技术栈、版本声明、摸鱼Lab 团队主页 | [查看图解](#28-关于-knowspace-与技术架构) |
...
- **现代化架构栈**：React 19 + TypeScript + Electron 42 + CodeMirror 6 + Cytoscape + KaTeX。
...
| **检索书签** | `Ctrl + F` | **全文搜索** | 呼出搜索侧栏并聚焦输入框（导图模式下聚焦导图检索） |
