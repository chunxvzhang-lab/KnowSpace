...
// Extracted during the R2 split (docs/CANVAS_SPLIT_DESIGN.md). Imported for the
// code still living in this file and re-exported at the bottom of this block so
// every existing `import { … } from "./canvasService"` keeps working untouched.
import {
