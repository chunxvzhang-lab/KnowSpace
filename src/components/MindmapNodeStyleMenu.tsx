...
import type { MindmapLink } from "../core/mindmapLinks";
import { MindmapAnnotationSections } from "./MindmapAnnotationSections";
...
export function MindmapNodeStyleMenu({
  ...
  return (
    ...
    >
      ...
      {/* The annotations, which are the same five for this topic and for one
          floating beside the outline — see MindmapAnnotationSections. They come
          first because they are what the reader came to the map to write, while
          the appearance controls below are how it looks. */}
